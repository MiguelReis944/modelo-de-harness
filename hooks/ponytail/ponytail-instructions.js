...
// Adaptado pro layout do harness: hooks/ponytail/ e catalog/skills/ponytail/
// são irmãos duas pastas acima, não hooks/../skills/ como no pacote original.
const SKILL_PATH = path.join(__dirname, '..', '..', 'catalog', 'skills', 'ponytail', 'SKILL.md');
